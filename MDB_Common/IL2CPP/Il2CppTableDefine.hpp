...
// ============================================================================
// IL2CPP Table Definitions - ECMA-335 Metadata Constants
//
// Attribute bitmask constants from the CLI specification:
//   - Field attributes   (ECMA-335 §II.23.1.5)
//   - Method attributes  (ECMA-335 §II.23.1.9 / §II.23.1.10)
//   - Type attributes    (ECMA-335 §II.23.1.13)
//   - Param attributes   (ECMA-335 §II.23.1.12)
//   - Generic parameter  (ECMA-335 §II.23.1.7)
//   - AssemblyRef flags  (ECMA-335 §II.23.1.2)
// ============================================================================

// ---------------------------------------------------------------------------
// Field Attributes (§II.23.1.5)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Method Implementation Attributes (§II.23.1.10)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Parameter Attributes (§II.23.1.12)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Generic Parameter Attributes (§II.23.1.7)
// ---------------------------------------------------------------------------
